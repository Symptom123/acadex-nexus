  ...
  return (
    <div className="h-screen flex bg-background overflow-hidden">
      ...
      <div className="hidden lg:block relative w-[45%] h-full flex-shrink-0 overflow-hidden">
        ...
        />
        {/* Gradient overlay — dark on left edge for logo, fade to transparent centre */}
      ...
      <div className="flex-1 flex flex-col px-6 py-6 lg:px-12 lg:py-10 bg-[#0a0a0f] overflow-y-auto">
        ...
        <div className="flex-1 flex items-center justify-center w-full py-10">
          ...
          <h1 className="font-heading text-3xl font-bold tracking-tight text-white mb-1">Sign in</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-11 rounded-xl bg-white/5 border border-white/10 text-white placeholder:text-white/30 focus:border-primary focus:ring-1 focus:ring-primary focus:bg-white/8 transition-all"
              />
            </div>
            <div className="space-y-1.5">
            ...
            <Button
              ...
              className="w-full h-11 font-semibold rounded-xl text-[15px] bg-primary text-white hover:bg-primary/90 shadow-[0_0_24px_rgba(139,92,246,0.35)] cursor-pointer transition-all duration-200"
            >
